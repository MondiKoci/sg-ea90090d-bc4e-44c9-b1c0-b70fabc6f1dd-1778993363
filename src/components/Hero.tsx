  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="container relative">
        <div className="grid lg:grid-cols-2 gap-12 items-center py-24 md:py-32 lg:py-40">
          {/* Content */}
          <div className="space-y-10">
            <div className="flex flex-wrap gap-3 animate-in fade-in slide-in-from-bottom-4 duration-1000">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 animate-in fade-in slide-in-from-bottom-7 duration-1000 delay-500">
          ...
          {/* Hero Image */}
          <div className="relative lg:block animate-in fade-in slide-in-from-right-8 duration-1000 delay-300">
            <div className="relative aspect-[4/3] rounded-3xl overflow-hidden shadow-2xl">
              {/* Placeholder for clinic/dentist photo */}
              <div className="absolute inset-0 bg-gradient-to-br from-primary/20 via-accent/10 to-primary/5 flex items-center justify-center">
                <div className="text-center space-y-4 p-8">
                  <div className="w-20 h-20 mx-auto rounded-full bg-card/50 backdrop-blur-sm flex items-center justify-center">
                    <Award className="w-10 h-10 text-primary" />
                  </div>
                  <p className="text-sm font-medium text-primary/70">
                    Hero Image Placeholder<br />
                    <span className="text-xs">Modern dental clinic or smiling patient</span>
                  </p>
                </div>
              </div>
            </div>
            ...
            {/* Floating stats card */}
            <div className="absolute -bottom-6 -left-6 bg-card rounded-2xl shadow-xl p-6 border border-border max-w-[240px]">
              <div className="space-y-2">
                <div className="text-4xl font-bold text-accent">$12,000</div>
                <div className="text-sm text-muted-foreground font-medium">Average savings per patient</div>
              </div>
            </div>
          </div>
        </div>
